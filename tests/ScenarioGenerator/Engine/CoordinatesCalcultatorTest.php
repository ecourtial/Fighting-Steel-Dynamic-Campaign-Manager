...
class CoordinatesCalcultatorTest extends TestCase
{
    private static CoordinatesCalculator $calculator;

    public function setUp(): void
    {
        static::$calculator = new CoordinatesCalculator();
    }
    ...
    public function testCoordinatesCalculation(int $heading, array $ships): void
    {
        ...
        switch ($heading) {
            case 0 :
                ...
                static::assertTrue($x1 === CoordinatesCalculator::ALLIED_X);
                static::assertTrue($x_y1 === CoordinatesCalculator::ALLIED_YARDS_X);
                ...
                static::assertTrue($x2 === CoordinatesCalculator::ALLIED_X);
                static::assertTrue($x_y2 === CoordinatesCalculator::ALLIED_YARDS_X);
            ...
            case 90 :
                ...
                static::assertTrue($z1 === CoordinatesCalculator::ALLIED_X);
                static::assertTrue($z_y1 === CoordinatesCalculator::ALLIED_YARDS_X);
                ...
                static::assertTrue($z2 === CoordinatesCalculator::ALLIED_Z);
                static::assertTrue($z_y2 === CoordinatesCalculator::ALLIED_YARDS_Z);
